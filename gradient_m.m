...
% Gradient descent training function with log_sigmoid activation
 weight1 = randn(input_dim, hidden_dim) * sqrt(2 / input_dim); % Reduced initial weights
 bias1 = zeros(1, hidden_dim);
 weight2 = randn(hidden_dim, output_dim)  * sqrt(2 / input_dim); % Reduced initial weights
